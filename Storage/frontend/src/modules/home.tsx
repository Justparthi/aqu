...
import { FaEye, FaEyeSlash, FaKey, FaBars, FaTimes, FaFolder, FaFile } from "react-icons/fa";
...
const HomePage: React.FC<UserInfo> = ({ user }) => {
	const [showKey, setShowKey] = useState<boolean>(false);
	const [sidebarOpen, setSidebarOpen] = useState<boolean>(false);
	const [leftSidebarOpen, setLeftSidebarOpen] = useState<boolean>(false); // New left sidebar state
			...
			<header className={styles.navbar}>
				<div className={styles.navbarContainer}>
					<div className={styles.logoArea}>
						{/* New Left Sidebar Toggle Button */}
						<button 
        ...
        ></path>
			...
			<div className={`${styles.leftSidebar} ${leftSidebarOpen ? styles.leftSidebarOpen : ''}`}>
				...
				<nav className={styles.leftSidebarNav}>
					...
					{/* <a className={styles.leftSidebarLink} href="#storage">
						Storage
					</a>
					<a className={styles.leftSidebarLink} href="#settings">
						Settings
					</a> */}
				</nav>
			</div>
			...
			{/* Existing Right Sidebar (Responsive) */}
